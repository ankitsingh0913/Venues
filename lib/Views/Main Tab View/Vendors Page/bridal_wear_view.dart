...
class BridalWearView extends StatefulWidget {
  const BridalWearView({Key? key}) : super(key: key);

  @override
  State<BridalWearView> createState() => _BridalWearViewState();
}

class _BridalWearViewState extends State<BridalWearView> {
